...
ops = {
    ...
    0x2F: (0x2f, 'push_imm()', 'imm = pOpcode[vmPc+1]; push(0x{0:x});', 2),
    ...
    0x8B: (0x8b, 'call_imm()', 'push(vmPc); imm = pOpcode[vmPc+1]; vmPc = 0x{0:x};', 2),
    ...
    0xC1: (0xc1, 'jmp_imm()', 'imm = pOpcode[vmPc+1]; vmPc = 0x{0:x};', 2),
    ...
    0xED: (0xed, 'jnz(x)', 'x = pop(); imm = pOpcodes[vmPc+1]; if (x != 0) vmPc = 0x{0:x};', 2),
